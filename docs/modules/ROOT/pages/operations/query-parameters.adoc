...
[TIP]
====
For more details on the Cypher parameters, see link:https://docs.graphfoundation.org/cypher-manual/{neo4j-version}/syntax/parameters/[Cypher Manual v.{neo4j-version} - Parameters^].
====

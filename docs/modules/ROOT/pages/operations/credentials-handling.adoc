:description: Credentials handling in ONgDB Browser.


[[credentials-handling]]
= Browser credentials handling

ONgDB Browser has two mechanisms for avoiding users having to enter their Neo4j credentials repeatedly.

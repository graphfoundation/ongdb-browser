...
To change the configuration settings for all users of ONgDB Browser, modify the _neo4j.conf_ file, or if using link:[ONgDB Desktop], navigate to the DBMS which settings you want to update, click the ellipsis dropdown menu, and select *Settings*.

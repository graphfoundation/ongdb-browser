...
The `:play start` browser command outputs an entry page containing interactive guides that you can use to learn some ONgDB concepts, try ONgDB with live data (MovieGraph), and write some basic Cypher queries.
...
For more information about Cypher, see link:https://docs.graphfoundation.org/cypher-manual/{neo4j-version}/[Cypher Manual^] and link:https://docs.graphfoundation.org/cypher-refcard/{neo4j-version}/[ONgDB Cypher Refcard^].
====

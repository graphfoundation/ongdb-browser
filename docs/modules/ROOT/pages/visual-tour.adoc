...
For more information, see link:https://neo4j.com/docs/desktop-manual/current/visual-tour/#files[ONgDB Desktop Manual -> Files^].

[[guides]]
=== Guides

The ONgDB Browser Guides drawer provides many interactive guides for learning concepts and tools with Neo4j.
...
[NOTE]
====
There are also other ONgDB Browser guides created by Neo4j staff and community members to help others learn Neo4j or how to use the tools in its ecosystem.
